This is a mod manager built to run on Linux (albeit with a bad UI). It does not locally download mods like CurseForge, but assumes you keep all your mods in a folder somewhere on your computer (which you input) and allows for the creation of custom-named modpacks with the given files.

----
# Features
- Custom modpack creation
- Ability to save & load immediately, save for later, or edit preexisting modpacks
  - Allows you to set what modloader you're using per modpack
- Loading of already saved modpacks
  - Stores your modpack in a folder called "modpacks/[loader]/[modpack name]", this keeps all the .jar files in one place (at the cost of storage)
